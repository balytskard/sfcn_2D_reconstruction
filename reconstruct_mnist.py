...
# MNIST images dimensions
params = {
    "imagex": 28,
    "imagey": 28
}

image_path = 'reconstruction_result_mnist'
os.makedirs(image_path, exist_ok=True)
reconstructed_img_name = 'test.png'
ground_truth_name = 'mnist_ground_truth.png'

model_path = 'models_by_blocks_mnist'
os.makedirs(model_path, exist_ok=True)
new_model_name = 'training_test.pt'
pretrained_model_name = 'mnist_model_jit_1block.pt'
...
loss_fn, trainloader, validloader, dm, ds =  inversefed.construct_dataloaders('MNIST_GRAY', defs)
